...
RUN PLATFORM=$(dpkg --print-architecture) && \
    ...
    https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6.1-3/wkhtmltox_0.12.6.1-3.bookworm_${PLATFORM}.deb \
    ...
    python3-freezegun python3-geoip2 python3-gevent python3-h11 python3-html2text python3-jinja2 python3-jwt \
    python3-libsass python3-lxml-html-clean python3-mako python3-markdown python3-matplotlib python3-mock \
    ...
    python3-pyldap python3-pyparsing python3-pypdf python3-qrcode python3-renderpm python3-reportlab python3-requests \
    ...
    && pip install --no-cache-dir ebaysdk inotify pdf417gen PyPDF2==2.12.1 \
