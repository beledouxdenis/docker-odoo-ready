...
RUN PLATFORM=$(dpkg --print-architecture) && \
    ...
    python3-fonttools python3-freezegun python3-geoip2 python3-gevent python3-h11 python3-html2text python3-jinja2 \
    python3-jwt python3-libsass python3-lxml python3-lxml-html-clean python3-mako python3-markdown python3-matplotlib \
    python3-mock python3-num2words python3-ofxparse python3-openid python3-openpyxl python3-openssl python3-passlib \
