...
RUN apt-get update -y \
    ...
    python3-suds python3-tz python3-unittest2 python3-vobject python3-werkzeug python3-xlrd python3-xlsxwriter \
    python3-xlwt python3-xmlsec python3-yaml python3-zeep \
